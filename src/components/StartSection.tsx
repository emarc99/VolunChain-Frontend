...
const StartSection = (props: Props) => {
    return (
        <section className="text-white flex justify-center items-center py-16">
            <div className="container mx-auto px-4 w-full md:px-6 xl:px-12">
                <div className="grid grid-cols-1 items-center lg:grid-cols-2 lg:flex lg:justify-between lg:w-[95%] lg:mx-auto gap-y-8 sm:gap-y-12 lg:gap-x-16">
